          ...
          builder: (context, order, child) {
            ...
            if (order.orderDetails != null) {
              order.orderDetails.forEach((orderDetails) {
                ...
                _shipping = _shipping + (orderDetails.shipping.cost);
              });
            }
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(order.orderDetails[0].deliveryStatus.toUpperCase(), style: titilliumSemiBold),
                          ),
                        ]
                    ),
                    SizedBox(height: 10),
                              ...
                              onTap: () async {
                                if(Provider.of<OrderProvider>(context, listen: false).orderStatusType == Provider.of<OrderProvider>(context, listen: false).orderStatusList[0]) {
                                  ...
                                  await Provider.of<OrderProvider>(context, listen: false).updateOrderStatus(
                                    _productIds, Provider.of<OrderProvider>(context, listen: false).orderStatusType,
                                  );
                                }
